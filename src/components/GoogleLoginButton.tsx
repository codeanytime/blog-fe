...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({
    ...
    // Use this effect to prevent double-initialization
    useEffect(() => {
    ...
    return (
        <button
            ref={buttonRef}
            className={`btn btn-light btn-lg d-flex align-items-center justify-content-center gap-2 w-100 border ${className}`}
            style={{
